...
export default function () {
    ...
    const page4 = Math.floor(Math.random() * 100) + 1;
    const brandId = Math.floor(Math.random() * BRAND_ID_MAX) + 1; // 1~1000 사이의 브랜드 ID
    const resProducts4 = http.get(`${BASE_URL}/products?page=${page4}&size=30&brandId=${brandId}&sort=like_desc`, { headers });
    check(resProducts4, {
